...
####  erstes curl noch nciht auf open -- join
...
curl -L -X POST -H "Content-Type: application/json" -d '{"myvar1":"foo","myvar2":"bar","myvar3":"foobar"}' "http://u.dmw.zone/open?message=$mytext2"
